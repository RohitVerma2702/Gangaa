    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gram_panchayat', models.CharField(blank=True, max_length=250, null=True)),
                ('village', models.CharField(blank=True, max_length=250, null=True)),
                ('store_type', models.CharField(blank=True, max_length=250, null=True)),
                ...
                ('products', models.CharField(blank=True, max_length=250, null=True)),
                ('delivery_area', models.CharField(blank=True, max_length=250, null=True)),
